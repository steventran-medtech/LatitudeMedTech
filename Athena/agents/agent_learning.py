...
#   - Consulting/business sources (Big 4 mindset)
#   - AI/technology sources (staying current on tooling)
# Sources are RSS feeds where available; web pages otherwise.

AGENT_SOURCES: Dict[str, List[Dict]] = {
    ...
    "_shared": [
        ...
        # Historical scope — 50 years via PubMed Central (free medical literature)
